...
void MatchFile::GetRelativePath(const char* path1,
                                const char* path2,
                                char* relative_path) {
  int i = 0;
...
void MatchFile::MoveRecordToEnd(int i) {
  ...
  _record_definition.insert(
      _record_definition.begin() + _header.definition_size - len,
      temp.begin(),
      temp.begin() + len);
...
void MatchFile::WriteFMatch(const char* image1,
                            const char* image2,
                            int NF,
                            int* index1,
                            int* index2,
...
void MatchFile::WriteIMatch(MatchFile* mat,
                            const char* image1,
                            const char* image2,
                            int NM,
                            TwoViewGeometry& tvg,
...
void MatchFile::WriteIMatch(const char* image_match,
                            int reverse,
                            int NM,
                            TwoViewGeometry& tvg,
                            Points<int>& inliers) {
...
void MatchFile::WritePMatch(const char* image1,
                            const char* image2,
                            int fc1,
                            int fc2,
                            int NM,
...
void MatchFile::WritePMatch(const char* image_match,
                            int FC,
                            int NM,
                            Points<int>& matches,
                            int reverse) {
...
void MatchFile::UpdateHeaderAndRecordLoc() {
  ...
  if (_header.definition_size > _recordloc_unchanged) {
    ...
    write(_fid,
          &_record_definition[_recordloc_unchanged],
...
///////////////////////
int MatchFile::GetPMatch(const char* image_path,
                         int FC,
                         int& NM,
                         Points<int>& matches) {
  int index;
...
int MatchFile::GetPMatchR(const char* image_path,
                          int FC,
                          int& NM,
                          Points<int>& matches) {
  int index;
...
int MatchFile::GetIMatch(const char* image_path,
                         int FC,
                         TwoViewGeometry& tvg,
                         Points<int>& inliers) {
  int index;
...
int MatchFile::GetIMatchR(const char* image_path,
                          int FC,
                          TwoViewGeometry& tvg,
                          Points<int>& inliers) {
  int index;
